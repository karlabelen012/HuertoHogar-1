...
```ts
import { useCreateCategory, useListProductsByCategory, useUpdateProductStock, useListOrdersForUser } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useListOrdersForUser();
...
```js
import { createCategory, listProductsByCategory, updateProductStock, listOrdersForUser } from '@dataconnect/generated';
